...
class pGraphics::pSlider : public pGraphics {
    ...
    public:
    pSlider(std::pair<double, double> pos, std::pair<double, double> size, std::pair<double, double> minMax, int decimals, std::string fontLocation, int valueTextSize, pColor onColor, pColor offColor, pColor valueTextColor, void(*function)(double));
    ~pSlider();
